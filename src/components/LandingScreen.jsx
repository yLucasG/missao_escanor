...
export default function LandingScreen({ onLoginClick, checkoutURL }) {
  return (
    <div className="relative min-h-screen bg-void-950 flex flex-col items-center justify-center overflow-hidden font-sans text-neon-100">
      ...
      <div className="relative z-10 max-w-6xl mx-auto px-4 pt-24 pb-12 flex flex-col w-full">
        {/* Row Container */}
        <div className="flex flex-col-reverse md:flex-row items-center md:items-start justify-center gap-12 md:gap-16 w-full">
        ...
        {/* Card De Compra Centralizado Fora Das Colunas */}
        <motion.div 
          initial={{ opacity: 0, y: 30 }}
          animate={{ opacity: 1, y: 0 }}
          transition={{ duration: 0.8, delay: 0.4 }}
          className="w-full max-w-2xl mx-auto mt-12 bg-void-900/80 backdrop-blur-md border border-neon-700/50 rounded-2xl p-8 md:p-10 shadow-[0_0_50px_rgba(107,33,168,0.3)] flex flex-col items-center group relative overflow-hidden"
        >
